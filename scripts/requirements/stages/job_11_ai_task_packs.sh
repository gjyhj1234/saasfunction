#!/usr/bin/env bash
# job_11_ai_task_packs.sh — 生成 AI 编码任务包（含仓储/商城任务）
set -euo pipefail
...
共 16 个任务包，覆盖 MVP + 仓储 + 商城范围。
- 诊所管理: TASK-001 ~ TASK-006 (基础设施 + 诊所核心)
- 仓储管理: TASK-007 ~ TASK-009 (WMS)
- 商城系统: TASK-015 ~ TASK-016 (Mall)
- 前端: TASK-010 ~ TASK-014, TASK-016
